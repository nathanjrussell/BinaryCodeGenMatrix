...
set(BINARY_CODE_WORD_FETCH_TAG "2.5.0" CACHE STRING "Tag to fetch if BinaryCodeWord not found")
...
if(NOT BinaryCodeWord_FOUND)
    ...
    message(STATUS "BinaryCodeWord not found; fetching from ${BINARY_CODE_WORD_GIT_URL} tag v${BINARY_CODE_WORD_FETCH_TAG}")
